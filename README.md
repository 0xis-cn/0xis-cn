...
The reason I am still here is that GitHub has [degenerated into a social network](https://samhacker.xyz/blog/github-for-everyone/), which means that the use of GitHub is no longer a professional choice. As in all other social networks,

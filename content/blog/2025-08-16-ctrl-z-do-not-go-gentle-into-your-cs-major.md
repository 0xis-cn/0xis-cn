...
Before I begin, let me summarize a remark of [one brilliant peer](https://ieeexplore.ieee.org/author/37089890709), that variance is enormous, and joining the frontier requires a otherworldy stainless résumé. It is never too much to repeat this. However, since anyone actually aiming for that perfection is unlikely to read a post like this, I only deal with the question how large the the gap/residual will be if you fall short.

<!--more-->

## The industry lacks foundations

You have probably heard of the cliché that academia is ‘out of touch’ with practice. For computer science, I would be better say much of practice is not based on sounded discipline. Looking back: even Dijkstra’s algebraic proofs remain a distant dream. The flaws in productions are daily fodder for public mockery, but how can we demand rigor from a production pipeline that is less disciplined than alchemy? That [MIT retired 6.001 (SICP)](https://cs-giung.github.io/readings/katz-2016) was an admission that there are no choice but to conspire with the rules of launching rat race. Looking closer: many people are simply unequipped to think about cutting-edge problems. No comment is needed on how much sense AI hype-sters perceive for the theoretical big picture.[^ed]

[^ed]: I should have found a reference for this. I [selected this only by its title]((https://www.wheresyoured.at/sam-altman-is-full-of-shit/)), which is not a quality guarantee to the author Ed Zitron.

Hence the chronic disease of our field: rounded square résumés, glittering portfolios, and interview questions that might as well be stand-up comedy. I strongly recommend the [*Undergraduate Self-Help Guide from SUFE*](https://tieba.baidu.com/p/8537793715), for we are converging with business studies, unless you arrive with Fields-medal-level mathematical force. The barrier erected by school rankings is more and more insurmountable, and that is only the tiniest symptom of the convergence.

The public panic of professional moat as the bedrock of personal competitiveness misses the larger picture. A discipline without foundations does not just lack a moat. Its bigger problem is that aiming for the middle lands you at the bottom. Conformism everywhere, and no place for sublimity. The suspicious on technical salons yester-year is glue sustaining even-swelling clusters today. For many, ‹two bugs make a right› is the goal. Grinding for GPA or flaunting ego are merely corollaries of lacking goal.

Contrary to the popular claim that self-studying computer science is impossible, the myth is real. However, that is acquired merely by reading profound-sounding materials is all but serious. Even worse is the invented loftiness: mimeographed *canonical* books, or cult of an overnight genius. If you are unlucky enough to take a [course built on cult](https://blog.lyc8503.net/post/4-years-at-nju/), exercise your own judgment.

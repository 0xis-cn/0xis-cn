...
<p class=ml-smaller>本文最初由 Arlon de Serra Grande 以葡萄牙语撰写，Lionel Dricot（Ploum）联署<br>（物按：我核对了三种语言版本，Ploum 的法语发布版个别文句（主要是示例）略有不同。作为宣言，译文有时使用通行名词而非我一般使用的名词，如「国家」。以 CC BY-SA 4.0 发布。）</p>
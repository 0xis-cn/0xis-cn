...
---
UPDATE: It is [Kokanu](https://www.kokanu.com) now. Further updates of my
website will include further discussion to more languages.
...
group[^qq] that time, to whom all rights reserved.

[^qq]: QQ group number is 319906928.
...
## o teneme
<section style="font-size:1.5em;text-align:center">
<input type="text" name="trans" oninput="刡()"
style="width:min(540px,100%);background:transparent;border-width:0 0 thin 0;color:inherit" />
<p id="kokan-result" class="kaiti"></p>
</section>

## pata

<section class="temp-lang ml-new-character ml-pinyin" lang="cmn-Hans" id="tokima-hans">
<ruby>丫<rt>a</rt></ruby>
...
<ruby>眠<rt>jamu</rt></ruby>
<ruby>地<rt>jan</rt></ruby>
<ruby>误<rt>janlu</rt></ruby>
<ruby>左<rt>jasa</rt></ruby>
...
<ruby>醒<rt>wili</rt></ruby>
<ruby>夫<rt>win</rt></ruby>
...
window.onload = () => {
	...
	document.getElementById('tokima-hans'  ).childNodes.forEach(入);
};
function 刡() {
